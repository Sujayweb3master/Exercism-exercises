 ...
 */
export function getListOfWagons(...idsOfWagons) {
  return idsOfWagons
}
...
export function fixListOfWagons(ids) {
  const [firstWagonId, secondWagonId, ...restOfWagonsIds] = ids;
  return [...restOfWagonsIds, firstWagonId, secondWagonId];
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [locomotiveId, ...restOfTheWagonIds] = ids;

  return [locomotiveId, ...missingWagons, ...restOfTheWagonIds];
}
...
export function separateTimeOfArrival(information) {
  const {timeOfArrival, ...restOfProperties} = information;

 
  return [timeOfArrival, restOfProperties];
}
